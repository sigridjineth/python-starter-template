Read docs/CURRICULUM.md before conducting your work.

Always follow the instructions in docs/CURRICULUM.md's ```5. [실전 프로젝트: FastAPI 멀티모듈 애플리케이션](#5-실전-프로젝트-fastapi-멀티모듈-애플리케이션)
```

When I say "go", read docs/CURRICULUM.md.

write the test plan in docs/plan.md to implement docs/CURRICULUM.md's 5. [실전 프로젝트: FastAPI 멀티모듈 애플리케이션](#5-실전-프로젝트-fastapi-멀티모듈-애플리케이션)
